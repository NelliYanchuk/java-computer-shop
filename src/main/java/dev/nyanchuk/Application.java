...
public class Application {
	...
	public static void main(String[] args) {
        ...
        Computer computer1 = new Computer("Dell", 16, "Intel i7", OperatingSystem.MS_WINDOWS, 1200);
        Computer computer2 = new Computer("Apple", 8, "M1", OperatingSystem.APPLE_MACOS, 1500);
